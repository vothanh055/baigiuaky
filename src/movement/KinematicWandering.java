...
public class KinematicWandering {
	...
	public String toString() {
		return "KinematicWandering [character=" + character + ","
                        + " maxSpeed=" + maxSpeed + ", maxOrientation="
				+ maxRotation + "]";
	}
	...
	public KinematicOutput generateKinematicOutput() {		
		...
		Vector2D velocity = new Vector2D(Math.sin(character.getOrientation()), 
                        Math.cos(character.getOrientation()));
